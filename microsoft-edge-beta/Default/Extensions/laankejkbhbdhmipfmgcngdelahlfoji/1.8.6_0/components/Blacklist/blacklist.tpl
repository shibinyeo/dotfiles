    ...
    <div class="mt-10">
        <input type="checkbox" name="blockAllSites" id="blockAllSites"><label for="blockAllSites" class="blockAll">Block all websites except the ones in Allowed Sites list</label>
    </div>
