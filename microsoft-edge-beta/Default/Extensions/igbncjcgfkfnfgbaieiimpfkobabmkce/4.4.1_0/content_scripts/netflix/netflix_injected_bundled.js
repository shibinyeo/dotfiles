        ...
        try {
            if (e.source == window) {
                if (e.data.type && e.data.type === "SEEK") {
                    ...
                    if (isMovie() && "edge" === "edge" && Math.abs(getVideoPlayer().getCurrentTime() - getVideoPlayer().getDuration()) <= 6000) {
                        return;
                    }
                    getVideoPlayer().play();
                }
                    ...
                    if (isMovie() && "edge" === "edge" && Math.abs(player.getCurrentTime() - player.getDuration()) <= 6000) {
                        player.pause();
                    }
                    if (player) {
