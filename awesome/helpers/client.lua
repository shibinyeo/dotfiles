...
local floating_resize_amount = dpi(80)
local tiling_resize_factor = 0.15
...
function _client.right_client_placement(c)
	return gears.timer.delayed_call(function()
		awful.placement.right(c, { honor_padding = true, honor_workarea = true })
	end)
end
